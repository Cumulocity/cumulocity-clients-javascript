...
./node_modules/.bin/uglifyjs $FILES --compress --mangle -o build/main.js --source-map build/main.js.map --screw-ie8
echo 'Built main.js'
./node_modules/.bin/uglifyjs $FILES_ALL --compress --mangle -o build/main-standalone.js --source-map build/main-standalone.js.map --screw-ie8
