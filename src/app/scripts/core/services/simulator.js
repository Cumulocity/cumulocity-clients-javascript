...
.factory('c8ySimulator', ['$http', 'c8yBase', 'gettext',
function ($http, c8yBase, gettext) {
  ...
  function list(){
    ...
    return $http.get(simulatorUrl, {params: { pageSize: 2000 }})
  ...
  function changeState(simulator, newstate){
    ...
    data = {state: newstate},
    cfg = _.cloneDeep(defaultConfigSimulator);
  ...
  function createTemplate(template){
    ...
    cfg = _.cloneDeep(defaultConfigTemplate);
